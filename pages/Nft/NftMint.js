...
function NftMint({
    ...
    return ( <
        ...
        style = {
            {
                background: "url(" + nft_1 + ") 0% 0% / 100% 100%"
            }
        } >
        < /div> <
        /div> <
        ...
        style = {
            {
                background: "url(" + nft_2 + ") 0% 0% / 100% 100%"
            }
        } >
        < /div> <
        /div> <
        ...
        style = {
            {
                background: "url(" + nft_3 + ") 0% 0% / 100% 100%"
            }
        } >
        < /div> <
        /div> <
        ...
        <
        p >
        As the first hero of the Meta Legends, collection has over 9, 999 unique skins drawn from the different missions and challenges he faced throughout his life. <
        /p> <
        /div> <
        div >
        <
